...
## Where we are
- Operating Pack drafted by the Architect; awaiting Operator approval.
...
- Anthropic API key, Clerk keys, Convex deployment URL, Railway project: needed from Sprint 001 onward (see `QUESTIONS.md`).
